...
namespace RV_Park_Reservation_System.Pages.Admin.Reservations
{
    public class MakePaymentModel : PageModel
    {
        ...
        public MakePaymentModel(IUnitOfWork unitOfWork, UserManager<Customer> userManager)
        {
        ...
        public async Task<IActionResult> OnPost()
        {
            ...
            if (PaymentOption == "Card")
            {
                ...
                return RedirectToPage("/Admin/Reservations/MakeCardPayment");
            }
            else
            {
                reservationVM.paymentObj = _unitOfWork.Payment.Get(p => p.PayID == payID);
                ...
                HttpContext.Session.Set(SD.ReservationSession, reservationVM);
                HttpContext.Session.Set(SD.LongTermReservationSession, longTermReservationVM);
                return RedirectToPage("/Admin/Reservations/MakeCashPayment");
            }
