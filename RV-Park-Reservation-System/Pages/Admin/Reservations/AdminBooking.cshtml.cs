...
namespace RV_Park_Reservation_System.Pages.Admin.Reservations
{
    ...
    public class AdminBookingModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            //decide how passwords will be autogenerated and how they will be send to the user (SendMail)
        ...
        public async Task<IActionResult> OnPost()
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if(Input.accountOption == "newUser") //just a placeholder check, will update with real logic soon
                {
